...
FloatingWindow {
  ...
  component ProcessTable: ColumnLayout {
    ...
    NBox {
      ...
      ListView {
        ...
        model: win.rows; spacing: 1; clip: true; cacheBuffer: 400; boundsBehavior: Flickable.StopAtBounds
        delegate: Rectangle {
          id: rowDelegate
          required property var modelData
          readonly property bool expanded: win.expandedPid === rowDelegate.modelData.pid
          ...
          Column {
            ...
            Item {
              ...
              RowLayout {
                ...
                MetricPill { Layout.preferredWidth: 62 * Style.uiScaleRatio; active: win.sortMode === "cpu"; text: rowDelegate.modelData.cpu.toFixed(1) + "%" }
                MetricPill { Layout.preferredWidth: 84 * Style.uiScaleRatio; active: win.sortMode === "memory"; text: win._human(rowDelegate.modelData.rss) }
              ...
              MouseArea {
                ...
                onClicked: mouse => {
                  if (mouse.button === Qt.RightButton) {
                    ...
                    win.menuX = pt.x; win.menuY = pt.y; win.menuProc = rowDelegate.modelData
                  } else {
                    win.expandedPid = rowDelegate.expanded ? -1 : rowDelegate.modelData.pid
                  }
                }
              }
            }
            Rectangle {
              ...
              ColumnLayout {
                ...
                RowLayout {
                  ...
                  NIconButton { baseSize: Style.baseWidgetSize * 0.62; icon: "copy"; tooltipText: pluginApi?.tr("ctx.copyCommand"); onClicked: win.m?.copyText(rowDelegate.modelData.fullCommand || rowDelegate.modelData.name) }
                }
                RowLayout {
                  Layout.fillWidth: true; spacing: Style.marginS
  ...
  component ColumnHeader: Item {
    ...
    property string label: ""
    readonly property bool active: win.sortMode === ch.modeKey
    ...
    MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: win.sortMode = ch.modeKey }
  }
